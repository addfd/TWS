...
@user_private_router.message(F.text == "Ассортимент")
...
# Становимся в состояние ожидания ввода name
@user_private_router.message(StateFilter(None), F.text == "Добавить товар")
...
@user_private_router.message(AddProduct.price, or_f(F.text, F.text == "."))
...
@user_private_router.message(AddProduct.price)
